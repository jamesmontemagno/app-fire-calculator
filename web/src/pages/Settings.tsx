  ...
  return (
    <>
      ...
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-content sm:text-3xl">Settings</h1>
        ...
        <Card>
          <CardHeader>
            <h2 className="font-semibold text-content">Saved calculations</h2>
          ...
          <CardContent>
            {savedCalculations.length === 0 ? (
              <p className="text-sm text-content-muted">No calculator data is saved in this browser.</p>
            ) : (
              <>
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-sm">
                    <thead className="border-b border-border-subtle text-content-subtle">
                      <tr>
                    ...
                    <tbody>
                      {savedCalculations.map(calculation => (
                        <tr key={calculation.key} className="border-b border-border-subtle">
                          <td className="py-4 font-medium text-content">{calculation.section}</td>

...
export default function Legal() {
  return (
    <>
      ...
      />
      <article className="mx-auto max-w-3xl space-y-10 text-content-muted">
        <header>
        ...
        <section id="terms" className="scroll-mt-8 space-y-3">
          <h2 className="text-2xl font-semibold text-content">Terms of use</h2>
        ...
        <section id="privacy" className="scroll-mt-8 space-y-3">
          <h2 className="text-2xl font-semibold text-content">Privacy policy</h2>
          <p className="leading-7">

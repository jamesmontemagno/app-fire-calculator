...
public sealed record FatFireDraft(
    int CurrentAge,
    int RetirementAge,
    ...
    double AnnualExpenses)
{
    ...
    public static FatFireDraft Default { get; } = new(
        CurrentAge: 30,
        RetirementAge: 55,
    ...
    public bool IsWithinFatThreshold => AnnualExpenses >= FinancialCalculator.FatFireThreshold;

# My Fire # - App Store Connect Metadata
...
| --- | --- |
| App name | My Fire # |
| Subtitle | Private FIRE planning tools |
| Primary language | English (U.S.) |
| Bundle ID | `com.refractored.myfirenumber` |
| SKU | `my-fire-number-ios` |
...
| --- | --- |
| Version | 1.0 |
| Copyright | 2026 [legal seller or company name] |
| Price | Free |
| Availability | Select the countries and regions where the app should be available. |
...
My Fire # helps you explore your path to financial independence with a complete set of
private, easy-to-use planning tools.

Choose the calculator that fits your goals:
...
| Field | Value |
| --- | --- |
| Support URL | https://myfirenumber.com |
| Marketing URL | https://myfirenumber.com |
| Privacy Policy URL | https://myfirenumber.com/legal#privacy |
| Terms URL | https://myfirenumber.com/legal#terms |
...
Choose **Data Not Collected** in App Store Connect.

- No analytics or tracking SDKs
- No advertising
- No account creation or authentication
- No financial inputs transmitted off-device
- No server-side storage
- No third-party data sharing
- No use of the advertising identifier

The user can explicitly open legal web pages or share a locally generated export. These
user-initiated system actions do not cause the app to collect data.

## Age Rating Questionnaire

Select **None** or **No** for all content-frequency questions:
...
The app contains financial planning calculations but does not provide financial transactions,
trading, gambling, or personalized financial advice.

## Export Compliance and Regulations

| Question | Suggested answer |
| --- | --- |
| Does the app use encryption? | No; the app does not implement encryption or transmit financial data. |
| Does the app use IDFA? | No |
| Is the app a trader in the EU? | [Select based on the legal seller's status] |
| Digital Services Act contact details | [Complete if distributing in the EU] |

Confirm export-compliance answers against the final binary and the legal seller's obligations
before submission.

## Screenshots

Upload screenshots in this order for both display classes:
...
- Replace all bracketed legal seller and App Review contact placeholders.
- Confirm the app name is available in App Store Connect.
- Confirm pricing and country or region availability.
- Complete App Privacy as **Data Not Collected**.
- Complete age rating, export compliance, and EU trader-status questionnaires.
- Select the uploaded build and verify version/build numbers.
- Upload screenshots in the order above.
- Confirm the support, privacy, and terms URLs are publicly reachable.
- Add the final copyright holder.

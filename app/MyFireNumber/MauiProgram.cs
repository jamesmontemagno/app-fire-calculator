...
public static class MauiProgram
{
	public static MauiApp CreateMauiApp()
	{
		...
		builder.Services.AddSingleton<IProfileScenarioResolver, ProfileScenarioResolver>();
		builder.Services.AddSingleton<IScenarioModePromptService, ScenarioModePromptService>();
		builder.Services.AddSingleton<IRetirementCashFlowPromptService, RetirementCashFlowPromptService>();
		...
		builder.Services.AddSingleton<ISeppExportService, SeppExportService>();
		...
		builder.Services.AddSingleton<IProfileAccountRepository, SqliteProfileAccountRepository>();
		...
		builder.Services.AddTransient<RetirementCashFlowPage>();
		...
		builder.Services.AddTransient<RetirementCashFlowViewModel>();
